    ...
    [{{18681, 1}, "TP WTP WWAN Statistics 0.9",
     ...
     {{18681, 15}, "GPS Last Acquired Position",
      [{"Timestamp", 32, integer},
       {"WWAN Id", 8, integer},
       {"GPSATC", 0, binary}]},
     {{18681, 16}, "IEEE 802.11n WLAN Radio Configuration",
      [{"Radio ID", 8, integer},
       {"A-MSDU", 1, integer},
       {"A-MPDU", 1, integer},
       {"deny-non-11n", 1, integer},
       {"Short-GI", 1, integer},
       {"Bandwidth-Binding", 1, integer},
       {'_', 3},
       {"Max-Supported-MCS", 8, integer},
       {"Max-Mandatory-MCS", 8, integer},
       {"TX-Antenna", 8, integer},
       {"RX-Antenna", 8, integer},
       {'_', 16}
      ]},
